	...
	<p>
	Jos haluat musiikkihuoneen käyttäjäksi, ota yhteyttä musiikkihuoneen hoitajaan <a href="mailto:musiikkihuoneenhoitaja@satakuntatalo.fi">musiikkihuoneenhoitaja@satakuntatalo.fi</a>
	</p>
	<h2>Sisäänkirjaudu</h2>
<?php
